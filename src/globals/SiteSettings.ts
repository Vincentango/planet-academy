          ...
          fields: [
            {
              ...
              label: '设计变量（写入前台 CSS）',
              fields: [
                { name: 'paper', type: 'text', defaultValue: '#FCFCF7', label: '纸色 paper' },
                { name: 'ink', type: 'text', defaultValue: '#1F1C06', label: '墨色 ink' },
                { name: 'panel', type: 'text', defaultValue: '#FFFDF8', label: '面板 panel' },
                { name: 'chipYellow', type: 'text', defaultValue: '#F9E747', label: '标签色' },
                { name: 'chipPeach', type: 'text', defaultValue: '#FFCAC5', label: '辅色' },
                { name: 'accent', type: 'text', defaultValue: '#EB2A23', label: '强调色' },
                { name: 'radius', type: 'text', defaultValue: '0.95rem', label: '圆角' },
                { name: 'maxWidth', type: 'text', defaultValue: '80rem', label: '内容最大宽' },
              ],
            },
          ],
        },
