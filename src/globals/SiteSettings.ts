          ...
          fields: [
            {
              ...
              label: '设计变量（写入前台 CSS）',
              fields: [
                { name: 'paper', type: 'text', defaultValue: '#FFFFFF', label: '纸色 paper' },
                { name: 'ink', type: 'text', defaultValue: '#1C1C1C', label: '墨色 ink' },
                { name: 'panel', type: 'text', defaultValue: '#ffffff', label: '面板 panel' },
                { name: 'chipYellow', type: 'text', defaultValue: '#1C1C1C', label: '标签色' },
                { name: 'chipPeach', type: 'text', defaultValue: '#E8E8E8', label: '辅色' },
                { name: 'accent', type: 'text', defaultValue: '#1C1C1C', label: '强调色' },
                { name: 'radius', type: 'text', defaultValue: '0.55rem', label: '圆角' },
