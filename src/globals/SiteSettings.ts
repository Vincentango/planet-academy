          ...
          fields: [
            {
              ...
              label: '设计变量（写入前台 CSS）',
              fields: [
                { name: 'paper', type: 'text', defaultValue: '#F7F6F3', label: '纸色 paper' },
                { name: 'ink', type: 'text', defaultValue: '#111111', label: '墨色 ink' },
                { name: 'panel', type: 'text', defaultValue: '#ffffff', label: '面板 panel' },
                { name: 'chipYellow', type: 'text', defaultValue: '#111111', label: '标签色' },
                { name: 'chipPeach', type: 'text', defaultValue: '#d8d4cc', label: '辅色' },
                { name: 'accent', type: 'text', defaultValue: '#111111', label: '强调色' },
                { name: 'radius', type: 'text', defaultValue: '0.125rem', label: '圆角' },
