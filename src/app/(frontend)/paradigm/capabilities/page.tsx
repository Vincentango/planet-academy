    ...
    <>
      ...
      <section className="band-grey py-14">
        <div className="container-wide">
          ...
          <h2 className="headline mt-4 text-3xl">AI 能力 A/B/C/D · 横向贯穿层</h2>
          <p className="dek mt-3 max-w-3xl">它不是独立课程模块，而是 C1-C6 在 AI 使用场景中的具体化：当学生使用 AI 工具时，应当培养什么能力？</p>
          <div className="mt-6 grid gap-4 md:grid-cols-2">
            {ai.map((c) => (
              <article key={c.code} className="explain-item">
                <p className="kicker">{c.code}</p>
                <h3 className="headline mt-2 text-lg">{c.shortCode} {c.name}</h3>
